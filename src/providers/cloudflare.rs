...
impl<'a> ApiCacheFetcher<'a, i64> for CloudflareZoneFetcher<'a> {
...
impl<'a> ApiCacheFetcher<'a, i64> for CloudflareRecordFetcher<'a> {
    async fn fetch_api_response(&'a self) -> crate::Result<i64> {
...
impl CloudflareProvider {
    ...
    pub(crate) async fn create(
        ...
        let zone_id = self
            .zone_cache
            .get_or_update(&CloudflareZoneFetcher {
                client: &self.client,
    ...
    pub(crate) async fn delete(
        ...
        let record_id = self
            .record_cache
            .get_or_update(&CloudflareRecordFetcher {
                client: &self.client,
                zone_id,
                name: name.as_ref(),
            })
